...
import Button from "@/components/atoms/LoginBtn";
    ...
    <div>
      {openMenu ? (
        <div className="flex flex-row absolute z-10 top-0 right-0  min-h-fit min-w-full">
          ...
          <div className="basis-1/2 bg-white rounded-md font-notoSans font-semibold">
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white text-center">
      ...
      <button
        ...
        className="flex-initial absolute top-[18px] right-3 md:hidden"
      >
        <Bars3Icon className="w-10 h-10 text-gray-500" />
      </button>
    </div>
  );
};
