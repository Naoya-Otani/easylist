...
import Sorts from "@/src/components/parts/rakutan/Sorts";
import Filter from "@/src/components/parts/rakutan/Filter";
import AboutCourseList from "@/src/components/parts/rakutan/AboutCourseList";
                  ...
                  <div className="border border-t-1 border-b-0 border-x-0">
                    ...
                    <div className="flex flex-wrap mb-2 text-gray-500">
                      ...
                      {courseSummary.faculties.map((faculty, index) => {
                        return (
                          <p
                            className="mr-2 items-center text-center pb-[2px]"
                            key={index}
                          >
                            {faculty}
                          </p>
