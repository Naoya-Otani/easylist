...
const Policy = () => {
	return (
		<div className="outlineStyle">
			<h1 className="text-3xl font-semibold mt-12 mb-4 text-center">
				プライバシーポリシー
			</h1>
			<p>
				慶應楽単リスト（以下、「当サイト」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
			</p>
			<h1 className="text-2xl font-semibold mt-12 mb-4">第1条（個人情報）</h1>
			<p>
			...
			<p>
				当サイトは、本人から個人情報の開示を求められたときは、本人に対し、遅滞なくこれを開示します。ただし、開示することにより次のいずれかに該当する場合は、その全部または一部を開示しないこともあり、開示しない決定をした場合には、その旨を遅滞なく通知します。なお、個人情報の開示に際しては、1件あたり1000円の手数料を申し受けます。
			...
			<p>
				本ポリシーに関するお問い合わせは、下記のEメールアドレスまでお願いいたします。
				Eメールアドレス：naoyaotani914@gmail.com
			</p>
			<br />
			<p>以上</p>
		</div>
