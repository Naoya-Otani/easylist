    ...
    >
      <div className="flex items-center">
        ...
        <span className="ml-2 font-semibold">
          {source === "user" ? "あなた" : "楽単くん"}
        </span>
      </div>
      <div
        className={`mt-1 p-3 bg-gray-50 rounded-lg ${
          source === "user" ? "rounded-tr-none" : "rounded-tl-none"
        }`}
      >
      ...
      <div className="flex flex-col mt-6">
        <div className="flex items-center">
          ...
          <span className="ml-2 font-semibold">楽単くん</span>
        </div>
        <div
          className={`p-3 bg-gray-50 rounded-lg ${
            position === "left" ? "rounded-tr-none" : "rounded-tl-none"
          }`}
        >
          {loading ? (
            <TextStreamer
